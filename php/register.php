...
if(isset($_POST["submitData"])){
	...
	if(!filter_var($email, FILTER_VALIDATE_EMAIL)) {
		...
		$message = '<div class="alert alert-warning alert-dismissable fade in" align="center">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Invalid email entered.</strong> Please enter a valid email (example@example.com).</div>';
	...
	if ($error == true & isset($message) ) {
		...
		$stmt-> bind_param("ssssss", $username, $password, $firstName, $lastName, $locationState, $email);
        ...
        <div class="input-group">
          <span class="input-group-btn">
                <span class="btn btn-default btn-file">
                    Browse <input type="file" id="imgInp" name="profilePicture"/>
                </span>
          </span>
